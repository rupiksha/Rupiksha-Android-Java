...
public class ModelSubscriptionFetchBill {
    ...
    @Expose
    private List<ModelParamdetail> paramdetails;
    ...
    public List<ModelParamdetail> getParamdetails() {
        return paramdetails;
    }

    public void setParamdetails(List<ModelParamdetail> paramdetails) {
