...
public class DeviceAdapter extends ArrayAdapter<DeviceModel>
{
    ...
    public DeviceAdapter(@NonNull Context context, int resource, int textViewResourceId, @NonNull List<DeviceModel> objects, int center)
    {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        DeviceModel spinnerItem = getItem(position);
