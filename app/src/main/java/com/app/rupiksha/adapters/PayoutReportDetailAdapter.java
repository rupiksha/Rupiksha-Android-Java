...
public class PayoutReportDetailAdapter extends RecyclerView.Adapter<PayoutReportDetailAdapter.ViewHolder> {
    private Context context;
    private List<AEPSReportDetailModel> list;
    PayoutReportDetailAdapter.OnItemClick onItemClick;
    private int answerNum = -1;
    public PayoutReportDetailAdapter(Context context, List<AEPSReportDetailModel> stepList, OnItemClick onItemClick) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position)
    {
        ...
        holder.binding.bankUtr.setText(list.get(position).getRrn());
