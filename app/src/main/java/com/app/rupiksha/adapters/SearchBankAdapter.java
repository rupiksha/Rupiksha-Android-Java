...
public class SearchBankAdapter extends RecyclerView.Adapter<SearchBankAdapter.ViewHolder> {
    private Context context;
    private List<BankModel> list;
    OnItemClick onItemClick;

    public SearchBankAdapter(Context context, List<BankModel> listAnnonce, OnItemClick onItemClick) {
