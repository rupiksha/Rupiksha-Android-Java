...
public class BBPSReportDetailAdapter extends RecyclerView.Adapter<BBPSReportDetailAdapter.ViewHolder> {
    private Context context;
    private List<AEPSReportDetailModel> list;
    BBPSReportDetailAdapter.OnItemClick onItemClick;
    private int answerNum = -1;
    public BBPSReportDetailAdapter(Context context, List<AEPSReportDetailModel> stepList, OnItemClick onItemClick) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        BbpsReportLayoutBinding view = DataBindingUtil.bind(LayoutInflater.from(parent.getContext()).inflate(R.layout.bbps_report_layout, parent, false));
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position)
    {
        ...
        holder.binding.txOperator.setText(list.get(position).getBoperator());
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        private BbpsReportLayoutBinding binding;

        public ViewHolder(@NonNull BbpsReportLayoutBinding itemView) {
