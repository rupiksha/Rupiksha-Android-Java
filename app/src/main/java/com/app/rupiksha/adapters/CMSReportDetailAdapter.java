...
import com.app.rupiksha.databinding.BbpsReportLayoutBinding;
import com.app.rupiksha.databinding.CmsReportLayoutBinding;
import com.app.rupiksha.models.AEPSReportDetailModel;
import com.app.rupiksha.models.CMSReportModel;

import java.util.List;

public class CMSReportDetailAdapter extends RecyclerView.Adapter<CMSReportDetailAdapter.ViewHolder> {
    private Context context;
    private List<CMSReportModel> list;
    CMSReportDetailAdapter.OnItemClick onItemClick;
    private int answerNum = -1;
    public CMSReportDetailAdapter(Context context, List<CMSReportModel> stepList, OnItemClick onItemClick) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        CmsReportLayoutBinding view = DataBindingUtil.bind(LayoutInflater.from(parent.getContext()).inflate(R.layout.cms_report_layout, parent, false));
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position)
    {
      ...
      //  holder.binding.mobile.setText(list.get(position).getCanumber());
      //  holder.binding.lblType.setText(list.get(position).getDisplayName());
        holder.binding.txOperator.setText(list.get(position).getOperatorName());
     //   holder.binding.msg.setText("NA");
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        private CmsReportLayoutBinding binding;

        public ViewHolder(@NonNull CmsReportLayoutBinding itemView) {
