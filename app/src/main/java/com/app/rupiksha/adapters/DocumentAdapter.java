...
public class DocumentAdapter extends ArrayAdapter<AddressProof>
{
    private LayoutInflater layoutInflater;
    private Context mContext;
    private int gravity;

    public DocumentAdapter(@NonNull Context context, int resource, int textViewResourceId, @NonNull List<AddressProof> objects, int center)
    {
