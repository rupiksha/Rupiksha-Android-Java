...
import com.app.rupiksha.databinding.RowOtherExpensesDetailBinding;
...
public class OtherExpensesAdapter extends RecyclerView.Adapter<OtherExpensesAdapter.ViewHolder> {
    ...
    public OtherExpensesAdapter(Context context, List<TaxFormDetailModel> itrList, ItemClickListener clickListener) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        RowOtherExpensesDetailBinding annoncesRecycleviewListBinding = DataBindingUtil.bind(LayoutInflater.from(parent.getContext()).inflate(R.layout.row_other_expenses_detail, parent, false));
        ...
        if(itrList.get(position).getAmount()!= null && !itrList.get(position).getAmount().isEmpty())
            ...
            holder.binding.cardViewAdd.setOnClickListener(v -> {
                if(holder.binding.txtTitle.getText().toString().isEmpty())
                    ...
                    clickListener.itemClick(itrList.get(position),position,"AddOtherExpensesData");
                }
        });
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        private RowOtherExpensesDetailBinding binding;

        public ViewHolder(@NonNull RowOtherExpensesDetailBinding itemView) {
