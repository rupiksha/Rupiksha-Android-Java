...
public class RoleAdapter extends ArrayAdapter<RoleModel>
{
    ...
    public RoleAdapter(@NonNull Context context, int resource, int textViewResourceId, @NonNull List<RoleModel> objects, int center)
    {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        RoleModel spinnerItem = getItem(position);
