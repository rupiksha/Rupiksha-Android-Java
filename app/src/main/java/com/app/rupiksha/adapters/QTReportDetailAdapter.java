...
public class QTReportDetailAdapter extends RecyclerView.Adapter<QTReportDetailAdapter.ViewHolder> {
    private Context context;
    private List<AEPSReportDetailModel> list;
    QTReportDetailAdapter.OnItemClick onItemClick;
    private int answerNum = -1;
    public QTReportDetailAdapter(Context context, List<AEPSReportDetailModel> stepList, OnItemClick onItemClick) {
