...
import com.app.rupiksha.databinding.AepsReportLayoutBinding;
import com.app.rupiksha.models.AEPSReportDetailModel;

import java.util.List;

public class AEPSReportDetailAdapter extends RecyclerView.Adapter<AEPSReportDetailAdapter.ViewHolder> {
    private Context context;
    private List<AEPSReportDetailModel> list;
    AEPSReportDetailAdapter.OnItemClick onItemClick;
    private int answerNum = -1;
    public AEPSReportDetailAdapter(Context context, List<AEPSReportDetailModel> stepList, OnItemClick onItemClick) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        AepsReportLayoutBinding view = DataBindingUtil.bind(LayoutInflater.from(parent.getContext()).inflate(R.layout.aeps_report_layout, parent, false));
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position)
    {
        ...
        holder.binding.aadhar.setText(list.get(position).getAadhar());
        holder.binding.bankName.setText(list.get(position).getBank());
        holder.binding.msg.setText(list.get(position).getMessage());
        holder.binding.txRrn.setText(list.get(position).getRrn());
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        private AepsReportLayoutBinding binding;

        public ViewHolder(@NonNull AepsReportLayoutBinding itemView) {
