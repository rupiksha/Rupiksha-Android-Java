...
public class WalletToWalletReportDetailAdapter extends RecyclerView.Adapter<WalletToWalletReportDetailAdapter.ViewHolder> {
    private Context context;
    private List<AEPSReportDetailModel> list;
    WalletToWalletReportDetailAdapter.OnItemClick onItemClick;
    private int answerNum = -1;
    public WalletToWalletReportDetailAdapter(Context context, List<AEPSReportDetailModel> stepList, OnItemClick onItemClick) {
