...
public class ServiceTypeAdapter extends ArrayAdapter<SupportType>
{
    private LayoutInflater layoutInflater;
    private Context mContext;
    private int gravity;

    public ServiceTypeAdapter(@NonNull Context context, int resource, int textViewResourceId, @NonNull List<SupportType> objects, int center)
    {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        SupportType spinnerItem = getItem(position);
