...
public class BankAdapter extends ArrayAdapter<BankModel>
{
    ...
    public BankAdapter(@NonNull Context context, int resource, int textViewResourceId, @NonNull List<BankModel> objects, int center)
    {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        BankModel spinnerItem = getItem(position);
