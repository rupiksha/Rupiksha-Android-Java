...
import com.app.rupiksha.databinding.RechargeReportLayoutBinding;
import com.app.rupiksha.models.AEPSReportDetailModel;

import java.util.List;

public class RechargeReportDetailAdapter extends RecyclerView.Adapter<RechargeReportDetailAdapter.ViewHolder> {
    private Context context;
    private List<AEPSReportDetailModel> list;
    RechargeReportDetailAdapter.OnItemClick onItemClick;
    private int answerNum = -1;
    public RechargeReportDetailAdapter(Context context, List<AEPSReportDetailModel> stepList, OnItemClick onItemClick) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        RechargeReportLayoutBinding view = DataBindingUtil.bind(LayoutInflater.from(parent.getContext()).inflate(R.layout.recharge_report_layout, parent, false));
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position)
    {
        ...
        holder.binding.txOperator.setText(list.get(position).getOperator());
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        private RechargeReportLayoutBinding binding;

        public ViewHolder(@NonNull RechargeReportLayoutBinding itemView) {
