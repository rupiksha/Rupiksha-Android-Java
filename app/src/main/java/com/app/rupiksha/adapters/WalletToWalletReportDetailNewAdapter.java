...
public class WalletToWalletReportDetailNewAdapter extends RecyclerView.Adapter<WalletToWalletReportDetailNewAdapter.ViewHolder> {
    private Context context;
    private List<AEPSReportDetailModel> list;
    WalletToWalletReportDetailNewAdapter.OnItemClick onItemClick;
    private int answerNum = -1;

    public WalletToWalletReportDetailNewAdapter(Context context, List<AEPSReportDetailModel> stepList, OnItemClick onItemClick) {
