...
public class StateAdapter extends ArrayAdapter<StateModel>
{
    ...
    public StateAdapter(@NonNull Context context, int resource, int textViewResourceId, @NonNull List<StateModel> objects, int center)
    {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        StateModel spinnerItem = getItem(position);
