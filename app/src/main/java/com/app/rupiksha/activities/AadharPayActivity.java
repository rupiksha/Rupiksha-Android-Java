...
public class AadharPayActivity extends AppCompatActivity implements IAEPSServiceView , View.OnClickListener,GPSTracker.GPSTrackerInterface {
    ...
    String otp = "", errCode, fCount, fType, nmPoints , iCount , iType ,pType, pCount;
    String transaction = "";
    ...
    ActivityResultLauncher<Intent> launch = registerForActivityResult(new ActivityResultContracts.StartActivityForResult(),
            ...
            if (result.getResultCode() == Activity.RESULT_OK)
            {
                if(result.getData() != null){
                    ...
                    if(isSuccess){
                        ...
                        binding.btnsubmit.setText(getResources().getString(R.string.btn_text_submit));
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
       ...
       // setContentView(R.layout.activity_aeps_services);
        ...
        activity= AadharPayActivity.this;
        context= AadharPayActivity.this;
      ...
      //  binding.tildevice.setVisibility(View.GONE);
       // binding.btnsubmit.setText(getResources().getString(R.string.text_two_factor));
...
//        }
    ...
    /*private void checkValidation()
    {
      ...
      if(TextUtils.isEmpty(mobilenumber)){
        ...
        *//*  launch.launch(new Intent(context, APTwoFactorAuthenticationActivity.class)
        ...
        } else if ((requestCode == 1001))
        {
            if (resultCode == RESULT_OK)
            {
                if (data == null) {
                    ...
                    Bundle b = data.getExtras();
                    if (b != null) {
                        Log.e("Face Rd", String.valueOf(b));
                        ...
                        if (pidData != null && !pidData.isEmpty())
                        {
                            ...
                            if (submit_with.equalsIgnoreCase("xml_data")) {
                                ...
                                Log.e("FACE_RD_RAW_RESPONSE", pidData);
...
//                Toast.makeText(this, ""+e.getMessage(), Toast.LENGTH_SHORT).show();
            ...
            if (b == true) {
                ...
                for (int i = 0; i < 1; i++) {
                    ...
                    if (selectdevice == 1) { // Mantra device
                        iCount = "0";
                        pCount = "0";
                        iType  = "0";
                        pType  = "0";
                    } else {
                        iCount = currentItem1.getAttributes().getNamedItem("iCount").getNodeValue();
                        pCount = currentItem1.getAttributes().getNamedItem("pCount").getNodeValue();
                        iType  = currentItem1.getAttributes().getNamedItem("iType").getNodeValue();
                        pType  = currentItem1.getAttributes().getNamedItem("pType").getNodeValue();
                    }
               ...
               /* if(selectdevice==10){
                    ci = eSkey.getAttribute("ci");
                    NodeList skey = doc.getElementsByTagName("Skey");
                    Node SkeyNode = skey.item(0);
                    Element Skeyelement = (Element) SkeyNode;
                    // Skey Start
                    ...
                    for (int i = 0; i < 1; i++) {
                        Node currentItem1 = currentItemSkey.item(i);
                        ci = currentItem1.getAttributes().getNamedItem("ci").getNodeValue();
                        Skey = eSkey.getTextContent().trim();
                    }
                }*/
    ...
    private void aeps_aadharpay_api()
    {
        ...
        if (NetworkAlertUtility.isInternetConnection2(context)) {
           ...
           /* RequestBody requestBody = new MultipartBody.Builder()
            ...
            map.put("dsrno", RequestBody.create(value, MediaType.parse("multipart/form-data")));
            map.put("pidType", RequestBody.create(datatype, MediaType.parse("multipart/form-data")));
            map.put("pidData", RequestBody.create(data_data, MediaType.parse("multipart/form-data")));
            map.put("ci", RequestBody.create(ci, MediaType.parse("multipart/form-data")));
            map.put("dc", RequestBody.create(dc, MediaType.parse("multipart/form-data")));
            map.put("dpId", RequestBody.create(dpId, MediaType.parse("multipart/form-data")));
            map.put("errorCode", RequestBody.create(errCode, MediaType.parse("multipart/form-data")));
            map.put("fCount", RequestBody.create(fCount, MediaType.parse("multipart/form-data")));
            map.put("fType", RequestBody.create(fType, MediaType.parse("multipart/form-data")));
            map.put("hmac", RequestBody.create(Hmac, MediaType.parse("multipart/form-data")));
            map.put("mc", RequestBody.create(mc, MediaType.parse("multipart/form-data")));
            map.put("mi", RequestBody.create(mi, MediaType.parse("multipart/form-data")));
            map.put("nmPoints", RequestBody.create(nmPoints, MediaType.parse("multipart/form-data")));
            map.put("iCount", RequestBody.create(iCount, MediaType.parse("multipart/form-data")));
            map.put("iType", RequestBody.create(iType, MediaType.parse("multipart/form-data")));
            map.put("pType", RequestBody.create(pType, MediaType.parse("multipart/form-data")));
            map.put("pCount", RequestBody.create(pCount, MediaType.parse("multipart/form-data")));
            map.put("qScore", RequestBody.create(qScore, MediaType.parse("multipart/form-data")));
            map.put("rdsId", RequestBody.create(rdsId, MediaType.parse("multipart/form-data")));
            map.put("rdsVer", RequestBody.create(rdsVer, MediaType.parse("multipart/form-data")));
            map.put("sessionKey", RequestBody.create(Skey, MediaType.parse("multipart/form-data")));
            map.put("isFacialTan", RequestBody.create(String.valueOf(isFacialTan), MediaType.parse("multipart/form-data")));
            map.put("errorInfo", RequestBody.create("Success", MediaType.parse("multipart/form-data")));
            map.put("mobile", RequestBody.create(mobilenumber, MediaType.parse("multipart/form-data")));
            ...
            map.put("amount", RequestBody.create(sendamount, MediaType.parse("multipart/form-data")));
            map.put("lat", RequestBody.create(String.valueOf(stringLatitude), MediaType.parse("multipart/form-data")));
            map.put("log", RequestBody.create(String.valueOf(stringLongitude), MediaType.parse("multipart/form-data")));
            //=======================================
...
//            opts.otp = "123456";
    ...
    private void setbootomsheet()
    {
        ...
        userBottomSheet.setOnDismissListener(dialogInterface -> {
            isTwoFactorSuccess=false;
