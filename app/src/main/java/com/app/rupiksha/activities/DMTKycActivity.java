...
import com.app.rupiksha.apipresenter.DMTKycPresenter;
import com.app.rupiksha.constant.AppConstants;
import com.app.rupiksha.databinding.ActivityDmtkycBinding;
import com.app.rupiksha.extra.CustomToastNotification;
import com.app.rupiksha.extra.NetworkAlertUtility;
import com.app.rupiksha.interfaces.IDMTKycView;
...
public class DMTKycActivity extends AppCompatActivity implements View.OnClickListener, GPSTracker.GPSTrackerInterface , IDMTKycView {

    ActivityDmtkycBinding binding;
    private DMTKycActivity activity;
    Context context;
    private GPSTracker gps;
    private String stringLatitude = "0.0";
    private String stringLongitude = "0.0";
    private Location mLastLocation = null;
    private DMTKycPresenter presenter;
    ...
    String title="";
    String dmtKey="";
    String phoneNumber="",aadhar="",otpId="";
    boolean type=false;
    String aadharNo= "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding= DataBindingUtil.setContentView(this,R.layout.activity_dmtkyc);
        activity = DMTKycActivity.this;
        context = DMTKycActivity.this;

        presenter = new DMTKycPresenter();
        ...
        Log.d("addharNo","dmtkey:"+dmtKey+"  "+"aadhar:"+aadhar+"  "+"otp_id:"+otpId+"  ");
    ...
    private void checkValidation()
    {
     ...
     //   adharnumber = Objects.requireNonNull(binding.etadhar.getText()).toString();
        adharnumber=binding.etadhar.getText().toString();
        Log.d("dddd",adharnumber);
        if(adharnumber.isEmpty()){
            ...
            new CustomToastNotification(activity,getResources().getString(R.string.txt_aadhar_number_validation));
            ...
            doDeviceTask();
            Log.d("doDeviceTask","doDeviceTask click");
        }
    }
            ...
            try {
                try {
                    ...
                    if (pidOption != null) {
                        ...
                        intent2.setPackage("com.mantra.mfs110.rdservice");//new line added
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        Log.d("requestCode","requestCode"+requestCode+"resultcode"+resultCode);
        if (requestCode == 101) {
...
//                Toast.makeText(this, ""+e.getMessage(), Toast.LENGTH_SHORT).show();
            ...
            if (b == true) {
                ...
                if (transaction.equalsIgnoreCase("")) {
                    aadharNo = binding.etadhar.getText().toString();
                    if(aadharNo.isEmpty())
                        new CustomToastNotification(activity,getResources().getString(R.string.please_enter_aadhar));
...
//        String url = "http://developer.uidai.gov.in/uidauthserver/";
    ...
    private void fingureVerify(String data)
    {
        ...
        if (NetworkAlertUtility.isInternetConnection2(activity)) {
            ...
            RequestBody requestBody = new MultipartBody.Builder()
                    ...
                    .addFormDataPart("aadhar", aadharNo)
                    .addFormDataPart("newFingerData", data)
    ...
    public void onBiometricAuthenticationSuccess(BaseResponse body)
    {
        if(body!=null){
            new CustomToastNotification(activity,""+body.getMessage());
               Intent intent = new Intent(activity, DMTLoginActivity.class)
