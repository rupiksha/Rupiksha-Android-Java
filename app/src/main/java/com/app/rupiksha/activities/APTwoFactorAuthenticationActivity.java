...
import com.app.rupiksha.apipresenter.APTwoFAVerifyPresenter;
import com.app.rupiksha.constant.AppConstants;
import com.app.rupiksha.databinding.ActivityApTwoFactorAuthenticationBinding;
import com.app.rupiksha.extra.CustomToastNotification;
import com.app.rupiksha.extra.NetworkAlertUtility;
import com.app.rupiksha.interfaces.IAPTwoFAView;
...
public class APTwoFactorAuthenticationActivity extends AppCompatActivity implements IAPTwoFAView, View.OnClickListener, GPSTracker.GPSTrackerInterface {

    ActivityApTwoFactorAuthenticationBinding binding;
    Activity activity;
    Context context;
    String title="",mobilenumber,adharnumber,sendamount;
    boolean type=false;
    APTwoFAVerifyPresenter presenter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // setContentView(R.layout.activity_aeps_services);
        binding= DataBindingUtil.setContentView(this,R.layout.activity_ap_two_factor_authentication);
        activity= APTwoFactorAuthenticationActivity.this;
        context= APTwoFactorAuthenticationActivity.this;
        presenter= new APTwoFAVerifyPresenter();
        presenter.setView(this);
        binding.includeLayout.toolBar.setTitle(getResources().getString(R.string.title_aeps_ap_twofa));
        ...
        binding.tvtitle.setText(""+getResources().getString(R.string.title_aeps_ap_twofa));
        getDeviceList();
        setUpdevice();
...
//            opts.otp = "123456";
    ...
    @Override
    public void onApBiometricAuthenticationSuccess(BaseResponse body) {
        if(body!=null){
