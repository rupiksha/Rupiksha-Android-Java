...
import static com.mf.mpos.audio.c.e;
...
import com.app.rupiksha.apipresenter.TwoFAVerifyPresenter;
import com.app.rupiksha.constant.AppConstants;
import com.app.rupiksha.databinding.ActivityTwoFactorAuthenticationBinding;
import com.app.rupiksha.extra.CustomToastNotification;
import com.app.rupiksha.extra.NetworkAlertUtility;
import com.app.rupiksha.interfaces.ITwoFAView;
...
public class TwoFactorAuthenticationActivity extends AppCompatActivity implements ITwoFAView, View.OnClickListener, GPSTracker.GPSTrackerInterface {

    ActivityTwoFactorAuthenticationBinding binding;
    Activity activity;
    Context context;
    String title="",mobilenumber,adharnumber,sendamount;
    boolean type=false;
    TwoFAVerifyPresenter presenter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // setContentView(R.layout.activity_aeps_services);
        binding= DataBindingUtil.setContentView(this,R.layout.activity_two_factor_authentication);
        activity= TwoFactorAuthenticationActivity.this;
        context= TwoFactorAuthenticationActivity.this;
        presenter= new TwoFAVerifyPresenter();
        presenter.setView(this);
        binding.includeLayout.toolBar.setTitle(getResources().getString(R.string.title_aeps_twofa));
        ...
        binding.tvtitle.setText(""+getResources().getString(R.string.title_aeps_twofa));
        getDeviceList();
        setUpdevice();

        binding.btnsubmit.setOnClickListener(this);
        binding.btnUpdateAepsKyc.setOnClickListener(this);
    }
...
//                break;
//
//            case R.id.btnUpdateAepsKyc:
//                Intent intent = new Intent(activity,AepsKycActivity.class).putExtra("aepsStatus",aepsStatus);
...
//        }
        if (id == R.id.btnsubmit) {
            checkValidation();
        } else if (id == R.id.btnUpdateAepsKyc) {
            Intent intent = new Intent(activity,AepsKycActivity.class).putExtra("aepsStatus",aepsStatus);
            startActivity(intent);
   ...
   /* private String createPidOptions()
    {
       ...
       // String wadh = "sgydIC09zzy6f8Lb3xaAqzKquKe9lFcNR9uTvYxFp+A=";
         ...
         *//* String pidOptions = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n" +
                ...
                "   <Opts fCount=\"\" fType=\"\" iCount=\"\" iType=\"1\" pCount=\"1\" pType=\"0\" format=\"0\" " +
                  "pidVer=\"2.0\" timeout=\"\" otp=\"\" wadh=\"" + wadh + "\" posh=\"\" />\n" +
       ...
       *//* String pidOptions = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n" +
        ...
        String pidOptions = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n" +
                "<PidOptions ver=\"1.0\" env=\"" + "P" + "\">\n" +
                "   <Opts fCount=\"\" fType=\"0\" iCount=\"1\" iType=\"1\" pCount=\"1\" pType=\"0\" " +
                "format=\"0\" pidVer=\"2.0\" timeout=\"\" otp=\"\" wadh=\"" + wadh + "\" posh=\"\" />\n" +
                "   <Demo>Demographic Attributes as specified in authentication API</Demo>\n" +
                "   <CustOpts>\n" +
                "      <Param name=\"txnId\" value=\"" + txnId + "\"/>\n" +
                "   </CustOpts>\n" +
      ...
      *//*  try {
            ...
            serializer.startTag("", "PidOptions");
            serializer.attribute("", "ver", "1.0");
            serializer.attribute("", "env", "P");

            serializer.startTag("", "Opts");
            serializer.attribute("", "fCount", "0");
            if (selectdevice==10)
            {
                serializer.attribute("", "fType", "0");
            }else{
                serializer.attribute("", "fType", "0");
            }
            serializer.attribute("", "iCount", "0");
            serializer.attribute("", "iType", "0");
            serializer.attribute("", "pCount", "1");
            serializer.attribute("", "pType", "1");
            serializer.attribute("", "format", "0");
            serializer.attribute("", "pidVer", "2.0");
            serializer.attribute("", "timeout", "20000");
            serializer.attribute("", "otp", "");
            serializer.attribute("", "wadh", wadh);
            serializer.attribute("", "posh", "");
            serializer.endTag("", "Opts");

            serializer.startTag("", "CustOpts");

            serializer.startTag("", "Param");
            serializer.attribute("", "name", "txnId");
            serializer.attribute("", "value", txnId);
            serializer.endTag("", "Param");

            serializer.startTag("", "Param");
            serializer.attribute("", "name", "purpose");
            serializer.attribute("", "value", "auth");
            serializer.endTag("", "Param");

            serializer.startTag("", "Param");
            serializer.attribute("", "name", "language");
            serializer.attribute("", "value", "en");
            serializer.endTag("", "Param");

            serializer.endTag("", "CustOpts");

            serializer.endTag("", "PidOptions");
    ...
    private void fingureVerify()
    {
        ...
        if (NetworkAlertUtility.isInternetConnection2(context)) {
            ...
            RequestBody requestBody = new MultipartBody.Builder()
                    ...
                    .addFormDataPart("iCount", iCount)
                    .addFormDataPart("iType", iType)
                    .addFormDataPart("pType", pType)
                    .addFormDataPart("pCount", pCount)
    ...
    public void showtext()
    {
        ...
        if(!isAppInstalled) {
            if (selectdevice == 1) {
                ...
                String mainText = "Connect Your Aadhaar Face RD Device and download Aadhaar Face RDService. Click Here";
                String s1 = "Click Here";
                SpannableString spannableString = new SpannableString(mainText);
                int startPositionS1 = mainText.indexOf(s1);
                int endPositionS1 = mainText.lastIndexOf(s1) + s1.length();
                spannableString.setSpan(new ClickableSpan() {
                    ...
                    public void onClick(@NonNull View widget) {
                        ...
                        try {
                            ...
                            startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("http://play.google.com/store/apps/details?id=" + "in.gov.uidai.facerd")));
                        }
                    }
...
//            opts.otp = "123456";
    ...
    public void onBiometricAuthenticationSuccess(BaseResponse body)
    {
        if(body!=null){
            ...
            if(title.equalsIgnoreCase(context.getResources().getString(R.string.text_withdrawal_title))){
