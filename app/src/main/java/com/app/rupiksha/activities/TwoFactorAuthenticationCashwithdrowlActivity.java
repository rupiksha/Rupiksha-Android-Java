...
public class TwoFactorAuthenticationCashwithdrowlActivity extends AppCompatActivity implements ITwoFAView, View.OnClickListener, GPSTracker.GPSTrackerInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // setContentView(R.layout.activity_aeps_services);
        ...
        activity= TwoFactorAuthenticationCashwithdrowlActivity.this;
        context= TwoFactorAuthenticationCashwithdrowlActivity.this;
