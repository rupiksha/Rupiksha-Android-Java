...
public class AepsCashWithdrowlActivity extends AppCompatActivity implements IAEPSServiceView , View.OnClickListener,GPSTracker.GPSTrackerInterface
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
       ...
       // setContentView(R.layout.activity_aeps_services);
        ...
        activity= AepsCashWithdrowlActivity.this;
        context= AepsCashWithdrowlActivity.this;
...
//        }
    ...
    private void checkValidation()
    {
      ...
      if(TextUtils.isEmpty(mobilenumber)){
          ...
          launch.launch(new Intent(context, TwoFactorAuthenticationCashwithdrowlActivity.class)
