...
public class SupportFragmentPresenter extends BasePresenter<ISupportView>
{
    public static int retryCount = 0;


    public void getSupportData(Activity context, HashMap<String, String> headers, boolean isprocess)
    {
        if(isprocess)
            Utils.showProgressDialog(context,"");
        AppController.getInstance().getApiInterfaceTimeOut30Sec().getSupport(headers)
                .enqueue(new Callback<BaseResponse>() {
                    ...
                    public void onResponse(@NonNull Call<BaseResponse> call, @NonNull Response<BaseResponse> response) {
                        ...
                        {
                            getView().onSupportSuccess(response.body());
                        }else {
                            try {
                    ...
                    public void onFailure(@NonNull Call<BaseResponse> call, @NonNull Throwable t) {
                        ...
                        if (t instanceof TimeoutException || t instanceof SocketTimeoutException) {
                            ...
                            if (retryCount < 3) {
                                ...
                                getSupportData(context,headers,isprocess);
                            } else {
