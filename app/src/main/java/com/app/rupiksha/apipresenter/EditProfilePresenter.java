...
public class EditProfilePresenter extends BasePresenter<IEditProfileView>
{
    ...
    public void getEditProfile(Activity context, HashMap<String, String> headers,  HashMap<String, RequestBody> map, MultipartBody.Part uploadedPan, boolean isprocess) {
        // getView().enableLoadingBar(true, context.getString(R.string.msg_please_wait));
        if(isprocess)
            Utils.showProgressDialog(context,"");
        AppController.getInstance().getApiInterfaceTimeOut30Sec().editProfile(headers,map,uploadedPan)
                    ...
                    public void onFailure(@NonNull Call<BaseResponse> call, @NonNull Throwable t) {
                        ...
                        if (t instanceof TimeoutException || t instanceof SocketTimeoutException) {
                            ...
                            if (retryCount < 3) {
                                ...
                                getEditProfile(context,headers, map,uploadedPan,isprocess);
                            } else {
