...
public class ReportFragmentPresenter extends BasePresenter<IReportFragmentView>
{
    public static int retryCount = 0;


    public void getAllReportType(Activity context, HashMap<String, String> headers, boolean isprocess)
    {
        if(isprocess)
            Utils.showProgressDialog(context,"");
        AppController.getInstance().getApiInterfaceTimeOut30Sec().getAllReportType(headers)
                    ...
                    public void onFailure(@NonNull Call<BaseResponse> call, @NonNull Throwable t) {
                        ...
                        if (t instanceof TimeoutException || t instanceof SocketTimeoutException) {
                            ...
                            if (retryCount < 3) {
                                ...
                                getAllReportType(context,headers,isprocess);
                            } else {
