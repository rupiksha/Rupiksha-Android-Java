...
public class BBpsServicePresenter extends BasePresenter<IBBPSserviceView>
{
    public static int retryCount = 0;


    public void getbbpsService(Activity context, HashMap<String, String> headers, boolean isprocess)
    {
        if(isprocess)
            Utils.showProgressDialog(context,"");
        AppController.getInstance().getApiInterfaceTimeOut30Sec().getbbpsService(headers)
                    ...
                    public void onFailure(@NonNull Call<BaseResponse> call, @NonNull Throwable t) {
                        ...
                        if (t instanceof TimeoutException || t instanceof SocketTimeoutException) {
                            ...
                            if (retryCount < 3) {
                                ...
                                getbbpsService(context,headers,isprocess);
                            } else {
