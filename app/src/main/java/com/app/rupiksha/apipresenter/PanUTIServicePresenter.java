...
public class PanUTIServicePresenter extends BasePresenter<IPANserviceView>
{
    ...
    public void doPayoutTransaction(Activity context, HashMap<String, String> headers, RequestBody requestBody, boolean isprocess) {
        ...
        AppController.getInstance().getApiInterfaceTimeOut30Sec().doBuyCoupon(headers,requestBody)
                .enqueue(new Callback<BaseResponse>() {
                    ...
                    public void onResponse(@NonNull Call<BaseResponse> call, @NonNull Response<BaseResponse> response) {
                        ...
                        if (response.isSuccessful() && response.code() == 200)
                        {
                            ...
                            getView().onPANUTISuccess(response.body());
