...
public class CMSServicePresenter extends BasePresenter<ICMSserviceView>
{
    public static int retryCount = 0;
    public void getCMSService(Activity context, HashMap<String, String> headers, RequestBody requestBody, boolean isprocess) {
        if(isprocess)
            Utils.showProgressDialog(context,"");
        AppController.getInstance().getApiInterfaceTimeOut30Sec().cmsServiceapi(headers,requestBody)
                .enqueue(new Callback<BaseResponse>() {
                    ...
                    public void onResponse(@NonNull Call<BaseResponse> call, @NonNull Response<BaseResponse> response) {
                        ...
                        if (response.isSuccessful() && response.code() == 200)
                        {
                            ...
                            getView().onCMSserviceSuccess(response.body());
                    ...
                    public void onFailure(@NonNull Call<BaseResponse> call, @NonNull Throwable t) {
                        ...
                        if (t instanceof TimeoutException || t instanceof SocketTimeoutException) {
                            ...
                            if (retryCount < 3) {
                                ...
                                getCMSService(context,headers, requestBody,isprocess);
                            } else {
