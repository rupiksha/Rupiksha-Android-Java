...
public class ChangePasswordPresenter extends BasePresenter<IChangePasswordView>
{
    ...
    public void getchangepassword(Activity context,HashMap<String, String> headers, RequestBody requestBody,boolean isprocess) {
        // getView().enableLoadingBar(true, context.getString(R.string.msg_please_wait));
        if(isprocess)
            Utils.showProgressDialog(context,"");
        AppController.getInstance().getApiInterfaceTimeOut30Sec().changePassword(headers,requestBody)
                .enqueue(new Callback<BaseResponse>() {
                    ...
                    public void onResponse(@NonNull Call<BaseResponse> call, @NonNull Response<BaseResponse> response) {
                        ...
                        {
                            getView().onChangePasswordSuccess(response.body());
                        }else {
                            try {
                    ...
                    public void onFailure(@NonNull Call<BaseResponse> call, @NonNull Throwable t) {
                        ...
                        if (t instanceof TimeoutException || t instanceof SocketTimeoutException) {
                            ...
                            if (retryCount < 3) {
                                ...
                                getchangepassword(context,headers, requestBody,isprocess);
                            } else {
